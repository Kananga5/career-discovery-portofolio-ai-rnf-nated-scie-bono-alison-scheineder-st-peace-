...
Public Sub RunLifecycle(ByVal e As EventType, ByVal shiftId As Long)
    Select Case e
...
Private Function InitChecklist(ByVal shiftId As Long) As HandoverChecklistT
    Dim c As HandoverChecklistT
    c.shiftId = shiftId
    c.Timestamp = Now
    InitChecklist = c
...
Public Sub RunStage(ByVal s As Stage, ByVal learnerId As Long)
    Select Case s
...
Public Function CalcLinePrice(ByRef item As BOQItem) As Double
...
Public Sub AdvanceStep(Optional ByVal targetStep As TLPStep = 0)
...
Public Function LoadOfferFromSheet(ByVal rowIdx As Long) As Offer
...
Public Function NetPresentValueLCC(ByVal o As Offer, Optional ByVal years As Long = 10) As Double
...
Public Function WeightedScore(ByVal o As Offer) As Double
...
Public Function BestValueScore(ByVal o As Offer, ByVal costWeight As Double) As Double
...
Public Function RiskAdjustedScore(ByVal o As Offer, ByVal riskFactor As Double) As Double
